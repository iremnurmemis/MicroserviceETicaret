...
namespace MultiShop.Order.WebApi.Controllers
{
    ...
    public class OrderDetailsController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateOrderDetail(CreateOrderDetailCommand command)
        {
            ...
            return Ok("sipariş detayı basarıyla eklendi");
        }
        ...
        public async Task<IActionResult> UpdateOrderDetail(UpdateOrderDetailCommand command)
        {
            ...
            return Ok("sipariş detayı basarıyla güncellendi");
        }

        [HttpDelete]
        public async Task<IActionResult> RemoveOrderDetail(RemoveOrderDetailByIdCommand command)
        {
            await _removeOrderDetailCommandHandler.Handle(command);
            return Ok("sipariş detayı basarıyla silindi");
        }
